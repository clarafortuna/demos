...
const WANT_FN = [/* CLCPA-273 dep */ 'isPercentLiteral', /* CLCPA-267 dep */ 'shiftSchemaYears', /* CLCPA-272 deps */ 'reconcileSumColumns', 'detectSumColumns', 'withinSourceRounding', 'detectAvgColumns', 'columnNumericMask', 'detectCurrencyColumns', 'isNumeric', 'getTableSchema', 'parseCsvRows', 'normIngestKey', 'ingestComputed', 'isTotalOnlyDerived', 'buildIngestImport', /* CLCPA-261 dep */ 'detectPctColumns',
