 ...
 *
 * BASE predates the change: 4de6a8c (CLCPA-274's tip).
 *
 ...
 * side reads ed44cae, this ticket's own commit, because a
...
const NEWREV = process.env.DAC_NEW_COMMIT || 'ed44cae';
const BASE = process.env.DAC_BASE_COMMIT || '4de6a8c';
